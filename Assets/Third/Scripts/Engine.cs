...
public class Engine : MonoBehaviour
{
    ...
    class Root
    {
		public string giuahs;
        public string zseg4;
        public string jgmlmzx;
        public string njnwjx;
        public string goioqwe;
        public string aghsdfcs;
        public string gfiojauis;
		...
		{
			return !string.Join(giuahs, zseg4, jgmlmzx, njnwjx, goioqwe, aghsdfcs, gfiojauis).Contains(stopword);
		}
    }
}
